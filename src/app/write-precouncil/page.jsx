      ...
      <div className="container flex justify-center w-screen mx-auto">
        <WhiteContainer>
          {isLoading ? (
            ...
            <div className="max-w-6xl mx-auto p-6 bg-white rounded-lg shadow-md my-6">
              {/* Conteúdo principal */}
              ...
              {!isEditing && (
                <div
                  ...
                  role="alert"
                >
                  <strong className="font-bold">Formulário enviado! </strong>
                  <span className="block sm:inline">O formulário não pode mais ser editado.</span>
                </div>
              )}
            </div>
          )}
