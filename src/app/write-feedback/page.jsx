...
export default function WriteFeedback() {
  ...
  const students = [
    ...
    { name: "Valeria Valentim", status: "Sem feedback", avatar: "/placeholder.svg" },
  ...
  const teachers = [
    {
      ...
      feedback: "Professor de Matemática com excelente didática.",
    },
    {
      name: "Bianca Martins",
      avatar: "/placeholder.svg?height=40&width=40",
      feedback: "Professora de Física, muito dedicada aos alunos.",
    },
    {
    ...
    },
    {
      name: "Lara Costa",
      avatar: "/placeholder.svg?height=40&width=40",
      feedback: "Professora de Química com métodos inovadores de ensino.",
    },
    {
      name: "Mariana Rocha",
      avatar: "/placeholder.svg?height=40&width=40",
      feedback: "Professora de Biologia, especialista em genética.",
    },
    {
      name: "Pedro Lima",
      avatar: "/placeholder.svg?height=40&width=40",
      feedback: "Professor de História, com foco em história contemporânea.",
    },
  ]
  ...
  return (
    <div className="min-h-screen bg-gray-100 mx-auto">
      ...
      {isLoading ? (
        ...
        {/* For demo purposes - toggle between user types */}
        ...
        <span className="inline-block w-6 h-6 rounded-full overflow-hidden bg-green-500">
          <img src="/placeholder.svg?height=24&width=24" alt="Brazil flag" className="w-full h-full object-cover" />
        </span>
        <span className="inline-block w-8 h-8 rounded-full overflow-hidden border-2 border-white">
          <img src="/placeholder.svg?height=32&width=32" alt="User profile" className="w-full h-full object-cover" />
        </span>
      </div>
    </header>
      ...
      >
        ...
        <div className="p-3 flex-shrink-0">
          <div className="relative">
            ...
            <input
              ...
              className="w-full bg-white text-black rounded-md pl-9 pr-3 py-2 text-sm"
            />
          </div>
        </div>
        ...
        {userType === "technical" && (
          <div className="px-3 pb-2">
            <button
              className="w-full bg-blue-600 text-white py-2 px-3 rounded-md text-sm font-medium hover:bg-blue-500"
      ...
      <main className="flex-1 flex flex-col bg-gray-100 overflow-hidden">
        ...
        <div className="bg-white p-4 border-b flex justify-between items-center flex-shrink-0">
          {userType === "technical" ? (
            ...
            <>
              <div className="text-xl font-semibold text-blue-800">12/21 pré-conselhos</div>
              <div className="md:hidden">
                <button
                  className="text-blue-800 p-1 bg-gray-100 rounded-full shadow-md"
                  onClick={toggleSidebar}
        ...
        <div className="flex-1 overflow-y-auto p-3 md:p-6 relative">
          ...
          {/* Navigation arrows for technical users - always visible regardless of viewMode */}
          {userType === "technical" && (
            <>
              <button
          ...
          {/* Always show feedback card regardless of viewMode */}
          <div className="bg-white rounded-lg shadow-md overflow-hidden">
            ...
            <div className="bg-gray-200 p-3 md:p-4 flex items-center">
              ...
              {userType === "technical" && (
                <div className="text-xs md:text-sm text-gray-600">
                  AIPSIN {students.find((s) => s.name === selectedStudent)?.id || ""}
                </div>
              )}
              {userType !== "technical" && (
            ...
            <div className="p-3 md:p-4">
              ...
              <div className="flex justify-end mt-3 md:mt-4">
                <button className="bg-blue-800 text-white px-4 md:px-6 py-1.5 md:py-2 rounded-md hover:bg-blue-700 text-sm md:text-base">
                  Enviar
                </button>
              </div>
            </div>
